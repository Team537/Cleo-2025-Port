...
package frc.robot.subsystems.CLEO;
...
//   public static DutyCycleEncoder m_encoder = new DutyCycleEncoder(ArmConstants.ENCODER_DIO);
  ...
  public static double motionMagicTarget = m_leader.getPosition().getValueAsDouble();
//   public double encoderTarget = m_encoder.getAbsolutePosition();
  ...
  */
  public Arm() {
    ...
    motionMagicTarget = m_leader.getPosition().getValueAsDouble();
...
//   }
  ...
  */
  ...
  public void ArmManualStop() {
    SetMotorsPID(m_leader.getPosition().getValueAsDouble());
  } 
  ...
  */
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Follower Arm Positon", m_follower.getPosition().getValueAsDouble());
    SmartDashboard.putNumber("Leader Arm Positon", m_leader.getPosition().getValueAsDouble());
